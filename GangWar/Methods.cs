...
namespace GangWar
{
	public class Methods
	{
		...
		public void EnableGamemode()
		{
			...
			PlayerManager.localPlayer.GetComponent<Broadcast>().RpcAddElement("<color=green>Gangwar gamemode is enabled for the next round!</color>", 10, false);
		}
		...
		public IEnumerator<float> SetInventory(ReferenceHub hub, float delay)
		{
			...
			hub.ammoBox.SetOneAmount(1, "300");
		}
	}
}